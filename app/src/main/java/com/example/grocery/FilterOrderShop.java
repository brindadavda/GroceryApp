...
public class FilterOrderShop extends Filter {
    ...
    private AdapterOrderShop adadpter;
    private ArrayList<ModelOrderShop> filterList;

    public FilterOrderShop(AdapterOrderShop adadpter, ArrayList<ModelOrderShop> filterList) {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adadpter.modelOrderShopArrayList = (ArrayList<ModelOrderShop>) results.values;
        //refresh adapter
