...
public class FilterProduct extends Filter {
    ...
    private AdapterProductSeller adadpter;
    private ArrayList<ModeProduct> filterList;

    public FilterProduct(AdapterProductSeller adadpter, ArrayList<ModeProduct> filterList) {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adadpter.productArrayList = (ArrayList<ModeProduct>) results.values;
        //refresh adapter
